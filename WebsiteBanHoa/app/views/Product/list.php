...
<div class="d-flex justify-content-between align-items-center mb-4">
    ...
    <a href="/WebsiteBanHoa/Product/add" class="btn btn-success">
        ...
        <div class="card h-100 shadow-sm">
            <div class="card-img-top text-center p-3" style="height: 200px; display: flex; align-items: center; justify-content: center; background-color: #f8f9fa;">
                <?php if (isset($product->image) && !empty($product->image)): ?>
                    <img src="/WebsiteBanHoa/<?php echo $product->image; ?>" alt="<?php echo htmlspecialchars($product->name, ENT_QUOTES, 'UTF-8'); ?>"
            ...
            <div class="card-body">
                <h5 class="card-title">
                    <a href="/WebsiteBanHoa/Product/show/<?php echo $product->id; ?>" class="text-decoration-none">
            ...
            <div class="card-footer bg-transparent">
                <div class="d-flex justify-content-between">
                    <a href="/WebsiteBanHoa/Product/edit/<?php echo $product->id; ?>" class="btn btn-warning btn-sm">
                        <i class="bi bi-pencil"></i> Sửa
                    </a>
                    <a href="/WebsiteBanHoa/Product/delete/<?php echo $product->id; ?>" class="btn btn-danger btn-sm"
