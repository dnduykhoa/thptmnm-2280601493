...
<?php endif; ?> 
<form method="POST" action="/WebsiteBanHoa/Product/update" enctype="multipart/form-data" onsubmit="return validateForm();"> 
...
<a href="/WebsiteBanHoa/Product" class="btn btn-secondary mt-2">Quay lại danh sách sản phẩm</a> 
